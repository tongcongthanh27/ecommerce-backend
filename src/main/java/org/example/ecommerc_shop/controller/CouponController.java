...
public class CouponController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @GetMapping
    public ApiResponse<Page<CouponResponse>> getAllCoupon(@RequestParam(name = "page_size") Integer pageSize,
                                                          @RequestParam(name = "page_number") Integer pageNumbe){
        return ApiResponse.<Page<CouponResponse>>builder()
                .result(couponService.getAllCoupon(pageSize, pageNumbe))
                .build();
    }

    @PreAuthorize("hasRole('ADMIN')")
    @PutMapping("/{couponId}")
    public ApiResponse<CouponResponse> updateCoupon(@PathVariable String couponId, @RequestBody CouponUpdateRequest request){
        return ApiResponse.<CouponResponse>builder()
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @GetMapping("/{couponId}")
    public ApiResponse<CouponResponse> getCouponById(@PathVariable String couponId){
        return ApiResponse.<CouponResponse>builder()
    ...
    public ApiResponse<CouponResponse> updateStatus(@PathVariable String couponId, @RequestParam CouponStatus status){
        return ApiResponse.<CouponResponse>builder()
